...
public class LocalVariableTypeTable {
	...
	public void setStartPc(byte[] startPc) {
		if (startPc == null || startPc.length != Constant.U2) {
			throw new RuntimeException("LocalVariableTypeTable的startPc不能为null且长度必须为2字节");
		}
	...
	public void setLength(byte[] length) {
		if (length == null || length.length != Constant.U2) {
			throw new RuntimeException("LocalVariableTypeTable的length不能为null且长度必须为2字节");
		}
		this.length = length;
	}
	...
	public void setNameIndex(byte[] nameIndex) {
		if (nameIndex == null || nameIndex.length != Constant.U2) {
			throw new RuntimeException("LocalVariableTypeTable的nameIndex不能为null且长度必须为2字节");
		}
	...
	public void setSignatureIndex(byte[] signatureIndex) {
		if (signatureIndex == null || signatureIndex.length != Constant.U2) {
			throw new RuntimeException("LocalVariableTypeTable的signatureIndex不能为null且长度必须为2字节");
		}
	...
	public void setIndex(byte[] index) {
		if (index == null || index.length != Constant.U2) {
			throw new RuntimeException("LocalVariableTypeTable的index不能为null且长度必须为2字节");
		}
		this.index = index;
	}
